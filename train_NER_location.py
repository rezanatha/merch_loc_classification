...
def create_ner_dataset(data):
    ...
    for row in data.iter_rows():
        ner_data.append((row[1], {"entities": [(row[5][0], row[5][1], "LOC")]}))
    return ner_data
...
if __name__ == "__main__":
    ...
    # ner_data = create_ner_dataset(train)

    # SAVE NER DATASET INTO SPACY DATASET FORMAT
    #spacy_data = # PATH_TO_NER_DATA
    ...
    # EVALUATE MODEL FROM TEST DATA (SPLITTED FROM TRAINING DATA)
    evaluate_model(nlp, test_data)

    # EVALUATE MODEL FROM SEPARATE VALIDATION DATA
